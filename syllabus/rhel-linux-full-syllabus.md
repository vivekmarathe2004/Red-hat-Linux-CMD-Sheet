...
| Modules | Core Reading | Practice |
| --- | --- | --- |
| 01-03 | [Getting started](../docs/00-getting-started.md), [installation](../docs/01-installation-and-subscription.md), [packages](../docs/02-package-management-and-repos.md) | [Packages lab](../labs/packages-and-repos.md), [package repo scenario](../scenarios/package-repo-issue.md) |
| 04-05 | [Filesystem](../docs/03-filesystem-and-files.md), [users and permissions](../docs/04-users-groups-and-permissions.md) | [Users lab](../labs/users-and-groups.md), [permissions lab](../labs/permissions-and-acls.md) |
| 06-08 | [systemd](../docs/05-systemd-services-and-boot.md), [networking](../docs/06-networking.md), [firewall and SELinux](../docs/07-firewall-and-selinux.md) | [systemd lab](../labs/systemd-services.md), [networking lab](../labs/networking-basics.md), [SELinux scenario](../scenarios/selinux-denial.md) |
| 09-12 | [storage](../docs/08-storage-lvm-and-mounts.md), [logs](../docs/09-processes-logs-and-monitoring.md), [SSH](../docs/11-ssh-and-remote-access.md), [automation](../docs/14-automation-shell-and-cron.md) | [storage lab](../labs/storage-and-lvm.md), [SSH lab](../labs/ssh-remote-access.md), [broken fstab scenario](../scenarios/broken-fstab.md) |
| 13-15 | [containers](../docs/12-containers-podman-buildah-skopeo.md), [virtualization](../docs/13-virtualization.md), [security](../docs/10-security-and-hardening.md), [server recipes](../servers/README.md) | [containers lab](../labs/containers-podman.md), [web lab](../labs/web-server.md), [server recipes](../servers/README.md) |
| 16 | [troubleshooting](../docs/15-troubleshooting.md) | [troubleshooting drill](../labs/troubleshooting-drill.md), [all scenarios](../scenarios/README.md) |
